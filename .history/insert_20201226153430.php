...
function getImage() : string {
	return "images/".random_int(1,15).".jpg";
}
...
$st = $pdo->prepare('INSERT INTO users_2 (user_name,user_email,mobile_no,location,date) VALUES (:user_name,:user_email,:mobile_no,:gender,:location,:date,:image)');
