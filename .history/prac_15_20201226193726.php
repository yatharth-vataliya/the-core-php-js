          ...
          <form id="user_form">
            ...
            <div class="row p-2">
              <div class="col">
                ...
                <input type="text" id="state" name="state" class="form-control" placeholder="user_name">
              </div>
              <div class="col">
                <label class="form-control-label" for="user_email">City</label>
                <input type="email" id="city" name="city" class="form-control" placeholder="Useremail">
              </div>
            </div>
          </form>
        </div>
