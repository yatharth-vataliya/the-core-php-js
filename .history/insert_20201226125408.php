...
$st = $pdo->prepare('INSERT INTO sori_it (product_name,description,order_id) VALUES (:prodcut_name,:description,:order_id)');

$faker = Faker\Factory::create();


for($i = 0; $i < 100; $i++){
	$st->bindValue(':product_name',$facker->name);
	$st->bindValue(':description',$facker->text);
	$st->execute();
}
