  ...
  <div class="modal fade" id="userinfoModal" tabindex="-1" aria-labelledby="userinfoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <input type="button" id="submit_button" onclick="saveUserInfo();" value="save" style="display: none;" class="btn btn-primary">
        </div>
      </div>
    </div>
  </div>
    ...
    function format(d) {
      ...
      <div class="row p-2">
        <div class="col-md-12">
          ...
          <button class="btn btn-outline-warning" onclick="">Edit</button>
          <button class="btn btn-outline-danger" onclick="">Delete</button>
        </div>
      </div>
