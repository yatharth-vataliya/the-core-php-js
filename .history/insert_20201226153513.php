...
$st = $pdo->prepare('INSERT INTO users_2 (user_name,user_email,mobile_no,location,date,image) VALUES (:user_name,:user_email,:mobile_no,:gender,:location,:date,:image)');
